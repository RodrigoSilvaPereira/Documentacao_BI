    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 h-9 px-3 rounded-lg border border-slate-300 text-sm text-slate-800 bg-white placeholder:text-slate-400 hover:border-slate-400 focus:outline-none focus:border-brand-500"
        />
        <Button
          variant="outline"
          size="md"
