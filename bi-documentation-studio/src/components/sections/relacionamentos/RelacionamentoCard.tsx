...
export function RelacionamentoCard({ relacionamento: rel, onEdit, onDelete }: RelacionamentoCardProps) {
  const temporario = rel.temporario ?? false;
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-5 hover:border-slate-300 transition-colors group">
      ...
      <div className="flex flex-wrap items-center gap-2 mt-3 pt-3 border-t border-slate-100">
        ...
        {/* Badge especial para temporário */}
        {temporario && (
